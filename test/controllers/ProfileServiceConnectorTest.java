        ...
        running(fakeApplication(), new Runnable() {
            ...
            public void run() {
                ...
                assertEquals("When correct token in get request: "+ contentAsString(result),
                        200, status(result));
                assertEquals(contentAsString(result), "{\"_id\":{\"$oid\":\"554fc859e4b0db1ae750b43f\"},\"name\":\"kawiarnia\",\"category_list\":null,\"about\":null,\"location\":{\"city\":null,\"country\":null,\"street\":null},\"locationCoordinates\":{\"xCoordinate\":null,\"yCoordinate\":null},\"website\":null,\"music_genres\":null,\"phone\":null,\"picture_url\":null}");
